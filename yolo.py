...
class YOLO(object):
    _defaults = {
        "model_path"        : 'logs/Epoch33-Total_Loss1.2330-Val_Loss1.1303.h5',
        "anchors_path"      : 'model_data/yolo_anchors.txt',
        "classes_path"      : 'model_data/mango_class.txt',
        "score"             : 0.5,
        "iou"               : 0.3,
        "eager"             : True,
        "max_boxes"         : 100,
    ...
    def generate(self):
        ...
        if self.eager:
            ...
            outputs = Lambda(yolo_eval, output_shape=(1,), name='yolo_eval',
                ...
                'max_boxes': self.max_boxes, 'score_threshold': self.score, 'eager': True, 'letterbox_image': self.letterbox_image})(inputs)
